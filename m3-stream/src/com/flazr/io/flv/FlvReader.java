...
public class FlvReader implements RtmpMessageReader {
    ...
    public FlvReader(File file) {
        ...
        try {            
            ...
            Log.i(this.getClass().getName(),"opened file for reading: "+ absolutePath);
            Log.d(this.getClass().getName(),"flv file metadata: "+ metadata);
        } catch(Exception e) {
    ...
    public long seek(final long time) {
    	Log.d(this.getClass().getName(),"trying to seek to: "+ time);
        ...
        try {
            ...
            while(hasPrev()) {
                ...
                if(cursor.getHeader().isVideo() && isSyncFrame(cursor)) {
                	Log.d(this.getClass().getName(),"returned seek frame / position: "+ cursor);
    ...
    public boolean hasNext() {
        ...
        try {
        	...
        	Log.i(this.getClass().getName(),"exception when calling hasNext(): "+ e.getMessage());
            return false;
        }
    }
    ...
    protected boolean hasPrev() {
        ...
        try {
        	...
        	Log.i(this.getClass().getName(),"exception when calling hasPrev(): "+ e.getMessage());
            return false;
        }
    }
    ...
    public void close() {
        ...
        try {
            ...
            Log.i(this.getClass().getName(),"closed file: "+ absolutePath);
        } catch(Exception e) {
        	Log.i(this.getClass().getName(),"exception when closing file: "+ e.getMessage());
        }        
    }
    ...
    public static void main(String[] args) {
        ...
        while(reader.hasNext()) {
            ...
            Log.d(FlvReader.class.getName(),"" + message + " " + sync + " " + ChannelBuffers.hexDump(data));
        }
        reader.close();
    }
