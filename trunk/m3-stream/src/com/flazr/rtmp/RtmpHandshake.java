...
public class RtmpHandshake {
    ...
    public ChannelBuffer encodeClient1() {        
        ...
        Log.i(this.getClass().getName(), "using client version "+ Utils.toHex(clientVersionToUse));
        if (validationType == 0) {
            ownPartOne = out.copy(); // save for later
            return out;
        }        
        Log.d(this.getClass().getName(), "creating client part 1, validation type: "+ validationType);
        initKeyPair();
    ...
    private void decodeServer0(ChannelBuffer in) {
        ...
        if(rtmpe &&  flag != 0x06) {
        	Log.w(this.getClass().getName(), "server does not support rtmpe! falling back to rtmp");
            rtmpe = false;
        }
    }
    ...
    private void decodeServer1(ChannelBuffer in) {
        ...
        Log.d(this.getClass().getName(), "server time: "+Utils.toHex(peerTime)+", version: "+ Utils.toHex(serverVersion));
        if(swfHash != null) {
            // swf verification
            ...
            Log.i(this.getClass().getName(), "calculated swf verification response: "+ Utils.toHex(swfvBytes));
        }
        if(validationType == 0) {
            peerPartOne = in; // save for later
            return;
        }      
        Log.d(this.getClass().getName(), "processing server part 1, validation type: "+ validationType);
        ...
        Log.i(this.getClass().getName(), "server part 1 validation success");
    ...
    private void decodeServer2(ChannelBuffer in) {
        ...
        Log.d(this.getClass().getName(), "processing server part 2 for validation");
        ...
        Log.i(this.getClass().getName(), "server part 2 validation success");                       
    }
    ...
    public ChannelBuffer encodeClient2() {
        ...
        Log.d(this.getClass().getName(), "creating client part 2 for validation");
        ChannelBuffer out = generateRandomHandshake();
    ...
    public void decodeClient0(ChannelBuffer in) {
        ...
        Log.d(this.getClass().getName(), "client first byte "+Utils.toHex(firstByte)+", rtmpe: "+ rtmpe);        
    }
    ...
    public boolean decodeClient1(ChannelBuffer in) {
        ...
        Log.d(this.getClass().getName(), "client time: "+Utils.toHex(peerTime)+", version: "+ Utils.toHex(clientVersion));
        validationType = getValidationTypeForClientVersion(clientVersion);
        if(validationType == 0) {
            peerPartOne = in; // save for later
            return true;
        }        
        Log.d(this.getClass().getName(), "processing client part 1 for validation type: "+ validationType);
        initKeyPair();
        int digestOffset = digestOffset(in);
        peerPartOneDigest = new byte[DIGEST_SIZE];
        in.getBytes(digestOffset, peerPartOneDigest);
        ...
        Log.i(this.getClass().getName(), "client part 1 validation success");
        int publicKeyOffset = publicKeyOffset(in);
        peerPublicKey = new byte[PUBLIC_KEY_SIZE];
        in.getBytes(publicKeyOffset, peerPublicKey);
        initCiphers();
    ...
    public ChannelBuffer encodeServer1() {        
        ...
        Log.d(this.getClass().getName(), "creating server part 1 for validation type: "+ validationType);
    ...
    public void decodeClient2(ChannelBuffer raw) {
        ...
        Log.d(this.getClass().getName(), "processing client part 2 for validation");
        ...
        Log.i(this.getClass().getName(), "client part 2 validation success");                
    }
    ...
    public ChannelBuffer encodeServer2() {
        ...
        Log.d(this.getClass().getName(), "creating server part 2 for validation");
        ChannelBuffer out = generateRandomHandshake();
