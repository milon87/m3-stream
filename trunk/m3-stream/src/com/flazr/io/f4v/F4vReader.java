...
public class F4vReader implements RtmpMessageReader {
    ...
    public F4vReader(File file) {
        ...
        try {
            ...
            Log.d(this.getClass().getName(), "video decoder config inited: " + Utils.toHex(AVC1_BEGIN));
    ...
    public void close() {
        ...
        try {
            ...
            Log.e(this.getClass().getName(), "exception when closing file: " + e.getMessage());
        } 
    }
    ...
    public static void main(String[] args) {
        ...
        while(reader.hasNext()) {
        	Log.d(F4vReader.class.getName(), "read: " + reader.next());
        }
    }
