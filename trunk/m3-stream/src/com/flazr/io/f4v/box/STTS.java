...
public class STTS implements Payload {
    ...
    public void read(ChannelBuffer in) {
        ...
        Log.d(this.getClass().getName(),"no of time to sample records: "+ count);
        ...
        for (int i = 0; i < count; i++) {
            ...
            Log.d(this.getClass().getName(),"#"+i+" sampleCount: "+record.sampleCount+" sampleDuration: "+ record.sampleDuration);
            records.add(record);
        }
    }
